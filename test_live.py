...
def main():
    ...
    try:
        ...
        try:
            ...
            audio_bytes = elevenlabs.generate_audio_stream(
                data.get("briefing"))
        ...
        if 'response' in locals():
            print(
                f"Status Code: {response.status_code}")  # pylint: disable=used-before-assignment
            print(
                f"Response Body: {response.text}")  # pylint: disable=used-before-assignment
